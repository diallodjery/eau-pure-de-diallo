...
function DetailPage({ page, onBack, onAction, onAddMember, onDeleteMember, onEditInvoice, onDeleteInvoice, clients, operations, team, expenses, onExpenseSaved }: { page: Exclude<Page, "home">; onBack: () => void; onAction: (action: Action) => void; onAddMember: () => void; onDeleteMember: (member: TeamMember) => void; onEditInvoice: (operation: Operation) => void; onDeleteInvoice: (operation: Operation) => void; clients: Client[]; operations: Operation[]; team: TeamMember[]; expenses: Expense[]; onExpenseSaved: (expense: Expense) => void }) {
