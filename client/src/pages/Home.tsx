...
import { loadClients, loadExpenses, loadOperations, loadTeamMembers, deleteTeamMember, saveClient, saveExpense, saveInvoice, saveOperation, saveTeamMember, updateClient, updateInvoice, updateOperation, type Client, type Expense, type Operation, type TeamMember } from "@/lib/operations";
...
function DetailPage({ page, onBack, onAction, onAddMember, onDeleteMember, onEditInvoice, clients, operations, team, expenses, onExpenseSaved }: { page: Exclude<Page, "home">; onBack: () => void; onAction: (action: Action) => void; onAddMember: () => void; onDeleteMember: (member: TeamMember) => void; onEditInvoice: (operation: Operation) => void; clients: Client[]; operations: Operation[]; team: TeamMember[]; expenses: Expense[]; onExpenseSaved: (expense: Expense) => void }) {
