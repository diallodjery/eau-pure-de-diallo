...
import { deleteInvoice, deleteOperation, loadClients, loadOperations, loadTeamMembers, saveClient, saveInvoice, saveOperation, saveTeamMember, updateClient, updateInvoice, updateOperation, type Client, type Operation, type TeamMember } from "@/lib/operations";
...
function DetailPage({ page, onBack, onAction, onAddMember, onEditOperation, onDeleteOperation, clients, operations, team }: { page: Exclude<Page, "home">; onBack: () => void; onAction: (action: Action) => void; onAddMember: () => void; onEditOperation: (operation: Operation) => void; onDeleteOperation: (operation: Operation) => void; clients: Client[]; operations: Operation[]; team: TeamMember[] }) {
