...
import { loadClients, loadExpenses, loadOperations, loadTeamMembers, saveClient, saveExpense, saveInvoice, saveOperation, saveTeamMember, updateClient, type Client, type Expense, type Operation, type TeamMember } from "@/lib/operations";
...
function DetailPage({ page, onBack, onAction, onAddMember, clients, operations, team, expenses, onExpenseSaved }: { page: Exclude<Page, "home">; onBack: () => void; onAction: (action: Action) => void; onAddMember: () => void; clients: Client[]; operations: Operation[]; team: TeamMember[]; expenses: Expense[]; onExpenseSaved: (expense: Expense) => void }) {
