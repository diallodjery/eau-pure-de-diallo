...
function DetailPage({ page, onBack, onAction, clients, operations }: { page: Exclude<Page, "home">; onBack: () => void; onAction: (action: Action) => void; clients: Client[]; operations: Operation[] }) {
  const config = {
...
export default function Home() {
  ...
  useEffect(() => {
    void Promise.all([loadClients(), loadOperations()]).then(([clientResult, operationResult]) => {
