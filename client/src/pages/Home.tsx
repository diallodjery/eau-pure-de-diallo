...
export default function Home() {
  ...
  const saveAction = async () => {
    ...
    const result = await saveOperation({
      type: activeAction,
      quantity: activeAction === "production" ? producedQuantity : activeAction === "sortie" ? 150 : activeAction === "retour" ? Math.max(0, packsOnRoute) : undefined,
    ...
    if (activeAction === "retour") { setStock(value => value + Number(retours || 0)); setRetours("95"); }
