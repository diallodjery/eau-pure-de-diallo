...
export default function Home() {
  ...
  return <div className="simple-app">
    <header className="simple-header">
      <div className="simple-brand"><div className="simple-logo"><Droplets size={20} /></div><div><strong>Aqua<span>Flow</span></strong><small>Ma gestion</small></div></div>
